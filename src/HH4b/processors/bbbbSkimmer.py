...
class bbbbSkimmer(SkimmerABC):
    ...
    def __init__(
        ...
        self.jms_values = dict.fromkeys(["2022", "2022EE", "2023", "2023BPix", "2024"]) # TODO: If we are not doing JECs for scouting, does one need to worry about this? A: We can do JECs but not worry about variations
