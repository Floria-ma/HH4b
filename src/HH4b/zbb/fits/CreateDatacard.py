...
nuisance_params = {
    ...
    "lumi_2023C": Syst(
        ...
        * LUMI["2023"]
        / LUMI[
            "2022-2023"
        ],  # I guess dividing by 2022-2023 is fair? I am not sure about these systematics
    ),
    "lumi_2023D": Syst(
        prior="lnN",
        samples=all_mc,
        ...
        * LUMI["2023BPix"]
        / LUMI[
            "2022-2023"
        ],  # I guess dividing by 2022-2023 is fair? I am not sure about these systematics; should it just be 2023All in lumi denom?
    ),
